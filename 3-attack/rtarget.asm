...
00000000004017ec <touch2>:
  ...
  4017f0:	89 fa                	mov    %edi,%edx # %rdx = %rdi
...
0000000000401968 <test>:
  ...
  401971:	e8 32 fe ff ff       	call   4017a8 <getbuf> # target:更改返回地址
  401976:	89 c2                	mov    %eax,%edx # %rdx = %rax
  401978:	be a8 32 40 00       	mov    $0x4032a8,%esi # %rsi = 0x4032a8
  40197d:	bf 01 00 00 00       	mov    $0x1,%edi # %rdi = 0x1
  401982:	b8 00 00 00 00       	mov    $0x0,%eax # %rax = 0
